...
def main():
    ...
    #meshes_folder = os.path.join(args.out_folder, "meshes")
    ...
    for img_path in img_paths:
        ...
        for batch in dataloader:
            ...
            for n in range(batch_size_):
                ...
                cv2.imwrite(os.path.join(visuals_folder, out_img_name), 255 * final_img[:, :, ::-1])
                ...
                if args.save_mesh:
                    ...
                    tmesh.export(os.path.join(meshes_folder, tmesh_name))
        ...
        if args.full_frame and len(all_verts) > 0:
            ...
            cv2.imwrite(os.path.join(visuals_folder, front_view_name), 255 * input_img_overlay[:, :, ::-1])
